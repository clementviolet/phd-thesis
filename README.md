Convertion partiel du modèle LaTeX de manuscript de thèse du Collège doctoral de Bretagne ([lien vers le project originel](https://gitlab.com/ed-matisse/latex-template)) pour fonctionner avec [pandoc](https://github.com/jgm/pandoc).
