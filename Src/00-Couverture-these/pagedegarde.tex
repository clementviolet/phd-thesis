...
\input{./00-Couverture-these/liste-ecoles-etablissements.tex}
...
Stéphane DRAY & Directeur de Recherche, Université Lyon 1 \\
...
% Pr\'{e}sident :        & Pr\'{e}nom NOM & Fonction et \'{e}tablissement d'exercice \textit{(à préciser après la soutenance)} \\
                       & Sakina-Dorothée AYATA & Maîtresse de conférences, Sorbonne Université\\
                       & Emmanuelle CAM & Professeure, Université de Bretagne Occidentale \\
                       & Thibault DE BETTIGNIES & Chargé de mission, PatriNat \\
                       & Stéphane DRAY & Directeur de Recherche, Université Lyon 1 \\
                       & David MOUILLOT & Professeur, Université de Montpellier \\
Directeur de th\`{e}se :    & Stanislas DUBOIS & Cadre de Recherche, Ifremer
