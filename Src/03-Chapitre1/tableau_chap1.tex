...
\begin{landscape}
\begin{table}[htbp]
\caption{Multi-assessment framework providing a list of useful metrics to assess, interpret or compare jSDMs across different ecological facets (rows) at the species, community or overall level. Italicized metrics are used in this study. The R code used to compute the metrics is provided in GitHub repository.}
...
\cline{1-1}\cline{3-5}
\multicolumn{1}{|c|}{$\beta$-diversity} & & \multicolumn{3}{|c|}{\shortstack[c]{\emph{Pairwise dissimilarity} (e.g. Jaccard/Bray-Curtis)\footnotemark\textsuperscript{,}\footnotemark,\\Total Beta diversity, Turnover,Nestedness,\\Local Contribution to Beta Diversity (LCBD),\\Species Contribution to Beta Diversity (SCBD)}} & & \\
\hline
